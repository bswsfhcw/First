...
import ToastMyAndroid from './ToastMyAndroid';
...
var ToastMyAndroidUse = React.createClass({
    ...
    render() {
        ...
        return (
            <View style={styles.container}>
                {/*导航*/}
                {this.renderNavBar()}
                <TouchableOpacity onPress={() => { ToastMyAndroid.show('js调用原生Toast', ToastMyAndroid.SHORT) }}>
                    <Text>调用原生Toast</Text>
                </TouchableOpacity>
...
//输出组件类
module.exports = ToastMyAndroidUse;